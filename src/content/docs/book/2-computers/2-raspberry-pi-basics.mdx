...
1. Save the code in a file (e.g., `led_blink.py`)
...
##### Discuss and Expand
* Why do we need only one resistor to rpevent damage to the components? We used two resistors with LED in previous activites. Think about what changed.
