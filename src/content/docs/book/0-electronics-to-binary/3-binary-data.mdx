...
Now that we know how we can use current to represent data within a digital system, the next step is to think about how to start using these ideas to work with different things we want to represent. For this we will look at common ways of representing binary in a shorter format, and then using binary to represent text. Similar ideas can then be applied to representing other things like colours, images, sounds, and so on.
...
Now have a go at creating a message using your 8-bit visualisation machine you created on the [Electronics and Binary](/book/0-introduction/2-electronics-data) page.
