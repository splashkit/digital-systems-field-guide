...
To wrap up this module, let's add in a push button to control when the light is active. The [Push Button LED Circuit](https://circuitdigest.com/electronic-circuits/push-button-led-circuit) will guide you through these steps.
